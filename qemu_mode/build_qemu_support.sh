...
sed -i '36i#include <linux/sockios.h>' linux-user/syscall.c
sed -i '262i#define __NR_sys_gettid __NR_gettid' linux-user/syscall.c
sed -i 's/_syscall0(int, gettid)/_syscall0(int, sys_gettid)/g' linux-user/syscall.c
